<?php
 if (!defined('BASEPATH')) {
    ...
    return $config = array(
        'internal_js' => array('stepper', 'csv_validator', 'mmp' ),
        'external_js' => array(
            ...
            // '<script src="../javascript/csv_validator.js" type="module"></script>',
            // '<script src="../javascript/stepper.js" type="module"></script>',
            // '<script src="../javascript/mmp.js" type="module"></script>',
        ),
    );
//EOF
