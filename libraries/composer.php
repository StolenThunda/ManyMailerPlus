...
/**
    ...
    public function send()
    {
        ...
        if (isset($extras['mailKey'])) $this->csv_email_column = $extras['mailKey'];
...
/**
    ...
    {	
        ...
        if (isset($this->email_in['template_content'])) $this->email_out['template_content'] = $this->email_in['template_content'];
        if (count($this->email_in['extras']) > 0 ) $this->email_out['extras'] = $this->email_in['extras'];
    ...
    **/
    ...
    function _send_mandrill($api_key, $subaccount)
    {
        ...
        if (isset($content['message']['extras'])){
            ...
            if (isset($content['message']['extras']['from_name'])) $content['message']['from_name'] = $content['message']['extras']['from_name'];
            if (isset($this->email_out['extras']['template_name'])) $content['template_name'] = $this->email_out['extras']['template_name'];
            if (isset($content['template_name']) && isset($content['message']['extras']['mc-edit'])){
                ...
                foreach($edits as $k => $v){
                    if ($k == 'main') $v = $content['message']['html'];
